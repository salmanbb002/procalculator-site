...
const TOOLS = [
  ...
  { id: 'kg-to-lbs', title: 'KG to Lbs Calculator', category: 'science', icon: '⚖️', badge: 'new', functional: true,
    desc: 'Convert kilograms to pounds and back, both ways, instantly.', tags: ['kg to lbs', 'kilograms to pounds', 'kg to pounds converter', 'weight conversion'] },
  { id: 'cm-to-feet', title: 'CM to Feet Calculator', category: 'science', icon: '📏', badge: 'new', functional: true,
    desc: 'Convert centimetres to feet and inches, or feet and inches back to cm.', tags: ['cm to feet', 'cm to feet and inches', 'height converter', 'centimetres to feet'] },
  { id: 'cm-to-inches', title: 'CM to Inches Calculator', category: 'science', icon: '📐', badge: 'new', functional: true,
    desc: 'Convert centimetres to inches and inches back to cm, instantly.', tags: ['cm to inches', 'centimetres to inches', 'cm to in converter'] },
  { id: 'fahrenheit-to-celsius', title: 'Fahrenheit to Celsius Calculator', category: 'science', icon: '🌡️', badge: 'new', functional: true,
    desc: 'Convert Fahrenheit to Celsius and Celsius to Fahrenheit, both ways.', tags: ['fahrenheit to celsius', 'celsius to fahrenheit', 'temperature converter', 'f to c'] },
  { id: 'km-to-miles', title: 'KM to Miles Calculator', category: 'science', icon: '🗺️', badge: 'new', functional: true,
    desc: 'Convert kilometres to miles and miles back to km, instantly.', tags: ['km to miles', 'kilometres to miles', 'miles to km converter', 'distance conversion'] },
  { id: 'inch-to-mm', title: 'Inch to MM Calculator', category: 'science', icon: '🔩', badge: 'new', functional: true,
    desc: 'Convert inches to millimetres and mm back to inches, instantly.', tags: ['inch to mm', 'inches to millimetres', 'mm to inches converter'] },
  { id: 'stone-to-kg', title: 'Stone to KG Calculator', category: 'science', icon: '🏋️‍♀️', badge: 'new', functional: true,
    desc: 'Convert stone and pounds to kilograms, or kg back to stone and pounds.', tags: ['stone to kg', 'stone to kilograms', 'stones to kg converter', 'weight conversion'] },
